...
func GetViewLMSCourseSectionServiceXML() interface{} {
	lexicalParserStr := `
	...
	<exec_group group_name="view_lms_course_section_pagination_data" group_condition="(ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil)&amp;&amp; ReqBrokerReqObj.request_data.search==nil">
		...
		<exec_function function_name="login_response_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_course_section_table_record">
	...
	<exec_group group_name="validate_view_lms_course_section"  group_condition="ReqBrokerReqObj.header_data.channel=='web_admin_portal' &amp;&amp; (ReqBrokerReqObj.request_data.course_id==nil &amp;&amp; ReqBrokerReqObj.request_data.id==nil) &amp;&amp; (ReqBrokerReqObj.request_data.page==nil &amp;&amp; ReqBrokerReqObj.request_data.per_page==nil)" >
		...
		<exec_function function_name="edit_lms_course_item_table_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_course_item_table_obj">
				<object_data key="course_id" data_source_type="reqbrokermap" data_source="lms_course_section_table_list[i].course_id" data_type="string"></object_data>
    ...
    *,
    COUNT(*) OVER() AS course_item_count
FROM "DEV_LMS"."LMS_COURSE_ITEM"
WHERE "COURSE_ID" = '{{.lms_course_item_table_obj.course_id}}'
  AND "SECTION_ID" = '{{.lms_course_item_table_obj.section_id}}';
</postgres_query_str>
				<store_obj_name>lms_course_section_table_list[i].lms_course_item</store_obj_name>
			</raw_query_info>
		</exec_function>
	...
	<exec_group group_name="validate_view_lms_course_section"  group_condition="ReqBrokerReqObj.header_data.channel=='web_admin_portal' &amp;&amp; ReqBrokerReqObj.request_data.course_id!=nil" >
		<exec_function function_name="read_view_lms_course_section_db_multi_read" function_type="db_multi_read">
			<db_multi_read_info>
				<table_name>LMS_COURSE_SECTION</table_name>
				<filter_info>
...
WHERE "COURSE_ID" = '{{.lms_course_item_table_obj.course_id}}'
  AND "SECTION_ID" = '{{.lms_course_item_table_obj.section_id}}';
	...
	<exec_group group_name="validate_view_lms_course_section"  group_condition="ReqBrokerReqObj.header_data.channel=='web_admin_portal' &amp;&amp; ReqBrokerReqObj.request_data.course_id!=nil &amp;&amp; ReqBrokerReqObj.request_data.id!=nil" >
		<exec_function function_name="read_view_lms_course_section_db_multi_read" function_type="db_single_read">
			<db_single_read_info>
				<table_name>LMS_COURSE_SECTION</table_name>
				<filter_info>
					<filter_data filter_name="COURSE_ID" filter_id="ReqBrokerReqObj.request_data.course_id" filter_data_type="string" filter_condition="AND"></filter_data>
		...
		<exec_function function_name="edit_lms_course_item_table_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_course_item_table_obj">
				<object_data key="course_id" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.course_id" data_type="string"></object_data>
				<object_data key="section_id" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.id" data_type="string"></object_data>
			</copy_object_info>
		</exec_function>
		<exec_function function_name="lms_course_item_count" function_type="raw_query" >
			<raw_query_info>
...
WHERE "COURSE_ID" = '{{.lms_course_item_table_obj.course_id}}'
  AND "SECTION_ID" = '{{.lms_course_item_table_obj.section_id}}';
				...
				<store_obj_name>lms_course_section_table_record.lms_course_item</store_obj_name>
			</raw_query_info>
		</exec_function>
		<exec_function function_name="view_lms_course_section_compose_response" function_type="compose_response">
			<response_info>
	...
	<exec_group group_name="view_lms_course_section_search_data" group_condition="(ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil)&amp;&amp; ReqBrokerReqObj.request_data.search!=nil">
		<exec_function function_name="lms_user_data_search_validate_fld" function_type="validate_fld">
			<validate_info app_err_desc="Validation failed for user data" app_corrective_action="Please validate the data">
				<validate_fld fld_name="ReqBrokerReqObj.request_data.page" fld_data_type="string" fld_min_len="1" fld_max_len="20" fld_type="pattern" fld_pattern="^[0-9]+$" app_err_desc="Invalid Page" app_corrective_action="Only letters are allowed."></validate_fld>
				<validate_fld fld_name="ReqBrokerReqObj.request_data.per_page" fld_data_type="string" fld_min_len="1" fld_max_len="20" fld_type="pattern" fld_pattern="^[0-9]+$" app_err_desc="Invalid Limit" app_corrective_action="Only letters are allowed."></validate_fld>
                <validate_fld fld_name="ReqBrokerReqObj.request_data.search" fld_data_type="string" fld_min_len="1" fld_max_len="20" fld_type="pattern" fld_pattern=".*" app_err_desc="Invalid search key" app_corrective_action="Only letters,alphabets are allowed and minimum length of search key is 1."></validate_fld>
			</validate_info>
		</exec_function>
		<exec_function function_name="course_section_search_copy_object" function_type="copy_object">
			<copy_object_info object_name="login_resp_obj">
				<object_data key="current_page" data_source_type="raw_value" data_source="1" data_type="string"></object_data>
		...
		<exec_function function_name="view_lms_course_section_data_compose_response" function_type="compose_response">
			<response_info>
				<resp_obj obj_name="lms_course_section_table_list" obj_type="object" data_source="lms_course_section_table_list"></resp_obj>
			</response_info>
		</exec_function>
	</exec_group>
</sem_lexical_parser>
