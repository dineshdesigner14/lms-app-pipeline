...
func GetFetchLMSMyCourseSectionServiceXML() interface{} {
	lexicalParserStr := `
	<sem_lexical_parser microservice="view_fetch_lms_my_course_section">
	<exec_group group_name="view_fetch_lms_my_course_section">
		...
		<exec_function function_name="lms_enquiry_course_db_single_read" function_type="db_single_read">
			...
			<err_info>
				<err_desc err_code="Duplicate" app_err_desc="Duplicate record found for email:{{decode_token_obj.email}}." app_corrective_action="Please make sure for a enquiry id linked with course id should be unique" />   
				<err_desc err_code="NoRows" app_err_desc="{{decode_token_obj.email}} not found" app_corrective_action="Make sure enquiry id is linked with courses." />
			</err_info>
		</exec_function>
		...
		<exec_function function_name="create_to_cust_enq_map_array" function_type="create_map_array">
			<map_array_info object_name="lms_course_section_progress" array_size="len(lms_course_section_progress_list)" />
		</exec_function>
		<exec_function function_name="lms_section_progress_loop" function_type="start_loop" index_name="i" start_index="0" end_index="len(lms_course_section_progress_list)" />
		  ...
		  <exec_function function_name="read_lms_course_db_multi_read" function_type="db_single_read">
			<db_single_read_info app_err_desc="Data Already Exists or No Rows in Result Set" app_corrective_action="check the inputs and provide proper values">
				...
				<filter_info>
					<filter_data filter_name="COURSE_ID" filter_id="lms_course_section_progress_list[i].course_id" filter_data_type="string" filter_condition="AND"></filter_data>
					<filter_data filter_name="ID" filter_id="lms_course_section_progress_list[i].section_id" filter_data_type="string" filter_condition="AND"></filter_data>
				</filter_info>
				<store_obj_name>lms_course_section_record</store_obj_name>
			</db_single_read_info>
		</exec_function>
		...
		<exec_function function_name="lms_course_section_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_course_section_progress[i]">
				<object_data key="course_id" data_source_type="reqbrokermap" data_source="lms_course_section_record.course_id" data_type="string"></object_data>
				<object_data key="section_id" data_source_type="reqbrokermap" data_source="lms_course_section_record.id" data_type="string"></object_data>
				<object_data key="title" data_source_type="reqbrokermap" data_source="lms_course_section_record.title" data_type="string"></object_data>
				<object_data key="description" data_source_type="reqbrokermap" data_source="lms_course_section_record.description" data_type="string"></object_data>
				<object_data key="order" data_source_type="reqbrokermap" data_source="lms_course_section_record.order" data_type="string"></object_data>
				<object_data key="is_completed" data_source_type="reqbrokermap" data_source="lms_course_section_progress_list[i].is_completed" data_type="Boolean"></object_data>
				<object_data key="is_enabled" data_source_type="reqbrokermap" data_source="lms_course_section_progress_list[i].is_enabled" data_type="Boolean"></object_data>
			</copy_object_info>
		</exec_function>

		<exec_function function_name="lms_section_progress_loop" function_type="end_loop" index_name="i" />

		
		<exec_function function_name="view_lms_course_compose_response" function_type="compose_response">
			<response_info>
				<resp_obj obj_name="lms_course_section_progress" obj_type="objectarray" data_source="lms_course_section_progress"></resp_obj>
			</response_info>
		</exec_function>
	</exec_group>
</sem_lexical_parser>
