...
func GetLMSQuestionBankBulkUploadServiceXML() interface{} {
	lexicalParserStr := `
	<sem_lexical_parser microservice="lms_question_bank_bulk_upload">
	...
	<exec_group group_name="lms_question_bank_bulk_upload" group_condition="ReqBrokerReqObj.header_data.channel=='web_admin_portal'">
		<exec_function function_name="lms_questions_loop" function_type="start_loop" index_name="i" start_index="0" end_index="len(ReqBrokerReqObj.request_data.questions)" />
		<exec_function function_name="lms_question_bank_bulk_upload_validate_fld" function_type="validate_fld">
			<validate_info app_err_desc="Validation failed for course section data" app_corrective_action="Please validate the data">
				<validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].course_id" fld_data_type="string" fld_min_len="1" fld_max_len="255" fld_type="pattern" fld_pattern="^[0-9.]+$" app_err_desc="Invalid course id" app_corrective_action="Only numbers are allowed."></validate_fld>
				<validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].section_id" fld_data_type="string" fld_min_len="1" fld_max_len="255" fld_type="pattern" fld_pattern="^[0-9.]+$" app_err_desc="Invalid section id" app_corrective_action="Only numbers are allowed."></validate_fld>
				<validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].item_id" fld_data_type="string" fld_min_len="1" fld_max_len="255" fld_type="pattern" fld_pattern="^[0-9.]+$" app_err_desc="Invalid item id" app_corrective_action="Only numbers are allowed."></validate_fld>
                <validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].question_group_id" fld_data_type="string" fld_min_len="1" fld_max_len="255" fld_type="pattern" fld_pattern="^[0-9.]+$" app_err_desc="Invalid item id" app_corrective_action="Only numbers are allowed."></validate_fld>
                <validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].explanation" fld_data_type="string" fld_min_len="1" fld_max_len="255" fld_type="pattern" fld_pattern=".*" app_err_desc="Invalid description" app_corrective_action="Only letters, numbers and spaces allowed."></validate_fld>
                <validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].question" fld_data_type="string" fld_min_len="1" fld_max_len="4000" fld_type="pattern" fld_pattern=".*" app_err_desc="Invalid question" app_corrective_action="Only letters, numbers and spaces allowed."></validate_fld>
			</validate_info>
		</exec_function>

		<exec_function function_name="lms_question_bank_bulk_upload_db_single_read" function_type="db_single_read">
			<db_single_read_info app_err_desc="lms course table is not found" app_corrective_action="course data cannot be configured as the table does not exist">
				...
				<filter_info>
					<filter_data filter_name="ID" filter_id="ReqBrokerReqObj.request_data.questions[i].course_id" filter_data_type="string" filter_condition="AND"></filter_data>
				</filter_info>
				<store_obj_name>lms_course_table_record</store_obj_name>
				</db_single_read_info>
				<err_info>
				  <err_desc err_code="Duplicate" app_err_desc="Duplicate records found for the course id provided in the input." app_corrective_action="Make sure each course id shows up only once." />   
				</err_info>
		</exec_function>
		<exec_function function_name="insert_lms_course_section_db_single_read" function_type="db_single_read">
			<db_single_read_info app_err_desc="lms question bank table is not found" app_corrective_action="question bank data cannot be configured as the table does not exist">
				...
				<filter_info>
					<filter_data filter_name="COURSE_ID" filter_id="ReqBrokerReqObj.request_data.questions[i].course_id" filter_data_type="string" filter_condition="AND"></filter_data>
					<filter_data filter_name="SECTION_ID" filter_id="ReqBrokerReqObj.request_data.questions[i].section_id" filter_data_type="string" filter_condition="AND"></filter_data>
					<filter_data filter_name="ITEM_ID" filter_id="ReqBrokerReqObj.request_data.questions[i].item_id" filter_data_type="string" filter_condition="AND"></filter_data>
					<filter_data filter_name="QUESTION" filter_id="ReqBrokerReqObj.request_data.questions[i].question" filter_data_type="string" filter_condition="AND"></filter_data>
				</filter_info>
				<result_info app_err_desc="The given question already exists." app_corrective_action="Please configure new question and proceed">
						<result_success>NoRows</result_success>
					</result_info>
				</db_single_read_info>
				<err_info>
				  <err_desc err_code="Duplicate" app_err_desc="Duplicate records found for the question provided in the input." app_corrective_action="Make sure each question shows up only once." />   
				</err_info>
		</exec_function>
		<exec_function function_name="lms_question_bank_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_question_bank_table_obj">
				<object_data key="course_id" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].course_id" data_type="string"></object_data>
				<object_data key="section_id" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].section_id" data_type="string"></object_data>
				<object_data key="item_id" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].item_id" data_type="string"></object_data>
				<object_data key="title" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].explanation" data_type="string"></object_data>
				<object_data key="description" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].explanation" data_type="string"></object_data>
				<object_data key="question" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].question" data_type="string"></object_data>
				<object_data key="difficulty" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].difficulty" data_type="string"></object_data>
				<object_data key="points" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].points" data_type="string"></object_data>
				<object_data key="explanation" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].explanation" data_type="string"></object_data>
	...
	<exec_function function_name="lms_options_loop" function_type="start_loop" index_name="j" start_index="0" end_index="len(ReqBrokerReqObj.request_data.questions[i].options)" />
		<exec_function function_name="lms_enquiry_comments_validate_fld" function_type="validate_fld">
			<validate_info app_err_desc="pattern validation failed for input" app_corrective_action="check the inputs and provide proper values">
				<validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].options[j].option_text" fld_data_type="string" fld_min_len="1" fld_max_len="500" fld_type="pattern" fld_pattern=".*"></validate_fld>
				<validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].options[j].order" fld_data_type="string" fld_min_len="1" fld_max_len="500" fld_type="pattern" fld_pattern="^[a-zA-Z0-9.,|_* -]+$"></validate_fld>
				<validate_fld fld_name="ReqBrokerReqObj.request_data.questions[i].options[j].is_correct" fld_data_type="boolean" fld_min_len="1" fld_max_len="500" fld_type="pattern" fld_pattern="^[a-zA-Z0-9.,|_* -]+$"></validate_fld>
			</validate_info>
		</exec_function>  
		<exec_function function_name="lms_question_options_table_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_question_options_table_obj">
				...
				<object_data key="option_text" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].options[j].option_text" data_type="string"></object_data>
				<object_data key="order" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].options[j].order" data_type="string"></object_data>
				<object_data key="is_correct" data_source_type="reqbrokermap" data_source="ReqBrokerReqObj.request_data.questions[i].options[j].is_correct" data_type="Boolean"></object_data>
				<object_data key="created_by" data_source_type="reqbrokermap" data_source="decode_token_obj.email" data_type="string"></object_data>
				<object_data key="created_date" data_source_type="key" data_source="get_date" data_type="string"></object_data>
				<object_data key="created_time" data_source_type="key" data_source="get_time" data_type="string"></object_data>
				<object_data key="updated_by" data_source_type="key" data_source="get_na" data_type="string"></object_data>
		...
		<exec_function function_name="lms_question_options_table_insert" function_type="db_insert">
			<db_insert_info app_err_desc="pattern validation failed for input" app_corrective_action="check the inputs and provide proper values">
				...
				<insert_data_list>
					...
					<insert_data insert_data_name="IS_CORRECT" insert_db_data_type="boolean" insert_data_source="lms_question_options_table_obj.is_correct" insert_data_type="Boolean"></insert_data>
		...
		<exec_function function_name="lms_options_loop" function_type="end_loop" index_name="j" />
    <exec_function function_name="lms_questions_loop" function_type="end_loop" index_name="i" />
       
			<exec_function function_name="lms_question_response_table_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_question_bank_table_obj">
				<object_data key="response" data_source_type="raw_value" data_source="Questions Inserted Successfully" data_type="string"></object_data>
			</copy_object_info>
		</exec_function>
		<exec_function function_name="lms_question_bank_compose_response" function_type="compose_response">
			<response_info>
				<resp_obj obj_name="lms_question_bank_table_obj" obj_type="object" data_source="lms_question_bank_table_obj"></resp_obj>
			</response_info>
		</exec_function>
	</exec_group>
</sem_lexical_parser>
