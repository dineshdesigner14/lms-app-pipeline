...
func GetViewLMSQuestionBankServiceXML() interface{} {
	lexicalParserStr := `
	...
	<exec_group group_name="view_lms_course_section_data" group_condition="ReqBrokerReqObj.header_data.channel=='web_admin_portal' &amp;&amp; ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil eqBrokerReqObj.request_data.search==nil">
		...
		<exec_function function_name="login_response_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_question_bank_table_record">
	...
	<exec_group group_name="validate_view_lms_question_bank"  group_condition="ReqBrokerReqObj.header_data.channel=='web_admin_portal' &amp;&amp; (ReqBrokerReqObj.request_data.question_id==nil &amp;&amp; ReqBrokerReqObj.request_data.option_id==nil &amp;&amp; ReqBrokerReqObj.request_data.id==nil) &amp;&amp; (ReqBrokerReqObj.request_data.course_id==nil &amp;&amp; ReqBrokerReqObj.request_data.section_id==nil &amp;&amp; ReqBrokerReqObj.request_data.item_id==nil) &amp;&amp; (ReqBrokerReqObj.request_data.page==nil &amp;&amp; ReqBrokerReqObj.request_data.per_page==nil)" >
	...
	<exec_group group_name="view_lms_question_bank_search_data" group_condition="ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil &amp;&amp; ReqBrokerReqObj.request_data.search!=nil">
		...
		<exec_function function_name="question_bank_search_copy_object" function_type="copy_object">
			<copy_object_info object_name="login_resp_obj">
				<object_data key="current_page" data_source_type="raw_value" data_source="1" data_type="string"></object_data>
		...
		<exec_function function_name="question_bank_search_auth_db_multi_read" function_type="db_multi_read">
		...
		<exec_function function_name="view_lms_question_bank_compose_response" function_type="compose_response">
			<response_info>
				<resp_obj obj_name="lms_question_bank_table_list" obj_type="object" data_source="lms_question_bank_table_list"></resp_obj>
			</response_info>
		</exec_function>
	</exec_group>
</sem_lexical_parser>
