...
func GetDeleteLMSCourseServiceXML() interface{} {
	lexicalParserStr := `
	<sem_lexical_parser microservice="delete_lms_course">
	<exec_group group_name="delete_lms_course" group_condition="ReqBrokerReqObj.header_data.channel=='web_admin_portal'">
		...
		<exec_function function_name="delete_lms_course_validate_fld" function_type="validate_fld">
			<validate_info>
				<validate_fld fld_name="ReqBrokerReqObj.request_data.id" fld_data_type="number" fld_min_len="1" fld_max_len="10" fld_type="pattern" fld_pattern="^[0-9]+$"></validate_fld>
			</validate_info>
		</exec_function>
		<exec_function function_name="delete_lms_course_auth_db_single_read" function_type="db_single_read">
			<db_single_read_info>
				<table_name>LMS_COURSE_AUTH</table_name>
				<filter_info>
		...
		<exec_function function_name="delete_lms_course_copy_object" function_type="copy_object">
			<copy_object_info object_name="delete_lms_course_additional_obj">
				<object_data key="deleted_by" data_source_type="reqbrokermap" data_source="user_data_table.UserID" data_type="string"></object_data>
		...
		<exec_function function_name="delete_lms_course_db_update" function_type="db_update">
			<db_update_info>
				<table_name>LMS_COURSE</table_name>
				<update_data_list>
					<update_data update_data_name="DELETED_BY" update_db_data_type="string" update_data_source="delete_lms_course_additional_obj.deleted_by" update_data_type="string"></update_data>
					<update_data update_data_name="DELETED_DATE" update_db_data_type="date" update_data_source="delete_lms_course_additional_obj.deleted_date" update_data_type="string"></update_data>
					<update_data update_data_name="DELETED_TIME" update_db_data_type="string" update_data_source="delete_lms_course_additional_obj.deleted_time" update_data_type="string"></update_data>
				</update_data_list>
				<update_filter_list>
