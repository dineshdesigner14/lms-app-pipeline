...
func GetEditLMSMeetingScheduleServiceXML() interface{} {
	lexicalParserStr := `
	<sem_lexical_parser microservice="edit_lms_meeting_schedule" group_condition="ReqBrokerReqObj.header_data.channel=='web_client_portal'">
		<exec_group group_name="edit_lms_meeting_schedule">
		...
		<exec_function function_name="verify_token_function_type" function_type="verify_token">
			...
			<exec_function function_name="edit_lms_meeting_schedule_validate_fld" function_type="validate_fld">
			...
			<exec_function function_name="edit_lms_enquiry_personal_info_auth_db_single_read" function_type="db_single_read">
			    <db_single_read_info app_err_desc="Data Already Exists or No Rows in Result Set" app_corrective_action="check the inputs and provide proper values">
			     	<table_name>LMS_MEETING_DATA</table_name>
				<filter_info>
					<filter_data filter_name="" filter_id="ReqBrokerReqObj.request_data.mobile_number" filter_data_type="string" filter_condition="AND"></filter_data>
				</filter_info>
			...
			<exec_function function_name="edit_lms_meeting_schedule_copy_object" function_type="copy_object">
				<copy_object_info object_name="edit_lms_meeting_schedule_additional_obj">
			...
			<exec_function function_name="edit_lms_meeting_schedule_db_update" function_type="db_update">
				<db_update_info>
					<table_name>LMS_USER_DATA</table_name>
					<update_data_list>
						<update_data update_data_name="FULL_NAME" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.full_name" update_data_type="string"></update_data>
                       <update_data update_data_name="EMAIL" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.email" update_data_type="string"></update_data>
                       <update_data update_data_name="ROLE" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.role" update_data_type="string"></update_data>
                       ...
                       <update_data update_data_name="PROFILE_PICTURE_URL" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.profile_picture_url" update_data_type="string"></update_data>
                       <update_data update_data_name="DATE_OF_BIRTH" update_db_data_type="date" update_data_source="edit_lms_meeting_schedule_additional_obj.date_of_birth" update_data_type="string"></update_data>
                       <update_data update_data_name="GENDER" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.gender" update_data_type="string"></update_data>
                       <update_data update_data_name="ADDRESS" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.address" update_data_type="string"></update_data>
                       <update_data update_data_name="BIO" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.bio" update_data_type="string"></update_data>
						<update_data update_data_name="UPDATED_BY" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.updated_by" update_data_type="string"></update_data>
						<update_data update_data_name="UPDATED_DATE" update_db_data_type="date" update_data_source="edit_lms_meeting_schedule_additional_obj.updated_date" update_data_type="string"></update_data>
						<update_data update_data_name="UPDATED_TIME" update_db_data_type="string" update_data_source="edit_lms_meeting_schedule_additional_obj.updated_time" update_data_type="string"></update_data>
					</update_data_list>
					<update_filter_list>
	...
	<exec_group group_name="edit_lms_meeting_schedule_compose_response">
