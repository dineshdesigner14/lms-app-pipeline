...
func GetViewLMSCourseItemServiceXML() interface{} {
	lexicalParserStr := `
	...
	<exec_group group_name="view_lms_course_section_data" group_condition="(ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil)&amp;&amp; ReqBrokerReqObj.request_data.search!=nil">
	...
	<exec_group group_name="view_lms_course_item_search_data" group_condition="(ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil)&amp;&amp; ReqBrokerReqObj.request_data.search!=nil">
		...
		<exec_function function_name="lms_course_item_search_auth_db_multi_read" function_type="db_multi_read">
		...
		<exec_function function_name="view_lms_user_data_compose_response" function_type="compose_response">
			<response_info>
				<resp_obj obj_name="lms_course_item_table_list" obj_type="object" data_source="lms_course_item_table_list"></resp_obj>
			</response_info>
		</exec_function>
	</exec_group>
</sem_lexical_parser>
