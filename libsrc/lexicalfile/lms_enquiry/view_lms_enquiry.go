...
func GetViewLMSEnquiryServiceXML() interface{} {
	lexicalParserStr := `
	<sem_lexical_parser microservice="view_lms_enquiry">
		<exec_group group_name="validate_view_lms_enquiry"  group_condition="ReqBrokerReqObj.header_data.channel=='web_client_portal'" >
		 ...
		 <exec_function function_name="role_validate_condition" function_type="validate_condition">
			<validate_condition_info app_err_desc="Invalid Role" app_corrective_action="Only ADMIN allowed to create enquiry.">
		...
		<exec_function function_name="verify_token_function_type" function_type="verify_token">
			...
			<exec_function function_name="view_lms_enquiry_validate_fld" function_type="validate_fld">
				<validate_info>
					<validate_fld fld_name="ReqBrokerReqObj.request_data.phone_number" fld_data_type="string" fld_min_len="1" fld_max_len="128" fld_type="pattern" fld_pattern="^[a-zA-Z0-9.,|_*]+$"></validate_fld>
				</validate_info>
			</exec_function>
		...
		<exec_group group_name="validate_view_lms_enquiry" group_condition="(ReqBrokerReqObj.request_data.page==nil &amp;&amp; ReqBrokerReqObj.request_data.per_page==nil)&amp;&amp; (ReqBrokerReqObj.request_data.enquiry_id==nil &amp;&amp;ReqBrokerReqObj.header_data.channel=='web_admin_portal')" >
			<exec_function function_name="decode_token_function_type" function_type="decode_token">
			<decode_token_info token_value="ReqBrokerReqObj.header_data.auth_token" token_object="decode_token_obj" app_err_desc="Decode token failed!. Invalid access token." app_corrective_action="Please provide valid access token."/>
		</exec_function>
		 <exec_function function_name="role_validate_condition" function_type="validate_condition">
		...
		<exec_function function_name="verify_token_function_type" function_type="verify_token">
			...
			<exec_group group_name="validate_view_lms_enquiry_id" group_condition="ReqBrokerReqObj.request_data.enquiry_id!=nil &amp;&amp;ReqBrokerReqObj.header_data.channel=='web_admin_portal'">
			<exec_function function_name="lms_enquiry_data_validate_fld" function_type="validate_fld">
			<validate_info app_err_desc="Validation failed for enquiry data" app_corrective_action="Please validate the data">
				<validate_fld fld_name="ReqBrokerReqObj.request_data.enquiry_id" fld_data_type="string" fld_min_len="1" fld_max_len="20" fld_type="pattern" fld_pattern="^[0-9]+$" app_err_desc="Invalid Page" app_corrective_action="Only letters are allowed."></validate_fld>
			</validate_info>
		</exec_function>
		<exec_function function_name="read_lms_enquiry_db_single_read" function_type="db_single_read">
			...
			<db_multi_read_info>
				...
				<store_obj_name>lms_enquiry_table_record.lms_enquiry_course_list</store_obj_name>
			</db_multi_read_info>
		</exec_function>
		...
		<exec_function function_name="read_view_lms_enquiry_comment_db_multi_read" function_type="db_multi_read">
			<db_multi_read_info>
				...
				<store_obj_name>lms_enquiry_table_record.comments</store_obj_name>
			</db_multi_read_info>
		</exec_function>
		<exec_function function_name="view_lms_enquiry_data_compose_response" function_type="compose_response">
			<response_info>
				<resp_obj obj_name="lms_enquiry_table_record" obj_type="object" data_source="lms_enquiry_table_record"></resp_obj>
			</response_info>
		</exec_function>
		</exec_group>
		<exec_group group_name="validate_view_lms_enquiry" group_condition="ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil &amp;&amp; ReqBrokerReqObj.request_data.search==nil">
			<exec_function function_name="lms_enquiry_data_validate_fld" function_type="validate_fld">
			<validate_info app_err_desc="Validation failed for enquiry data" app_corrective_action="Please validate the data">
		...
		<exec_function function_name="lms_enquiry_info_auth_db_multi_read" function_type="db_multi_read">
			<db_multi_read_info  order_by="UPDATED_DATE,UPDATED_TIME" limit="ReqBrokerReqObj.request_data.per_page" sort_type="desc,desc" offset="offset_resp_obj.offset" app_err_desc="Data Already Exists or No Rows in Result Set" app_corrective_action="check the inputs and provide proper values">
				<table_name>LMS_ENQUIRY</table_name>
				<store_obj_name>lms_enquiry_table_record</store_obj_name>
			</db_multi_read_info>
		</exec_function>
		<exec_function function_name="login_response_copy_object" function_type="copy_object">
			<copy_object_info object_name="lms_enquiry_table_record">
		...
		<exec_group group_name="view_lms_enquiry_search_data" group_condition="ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil &amp;&amp; ReqBrokerReqObj.request_data.search!=nil">
		...
		<exec_function function_name="enquiry_search_copy_object" function_type="copy_object">
			<copy_object_info object_name="login_resp_obj">
				<object_data key="current_page" data_source_type="raw_value" data_source="1" data_type="string"></object_data>
		...
		<exec_function function_name="lms_enquiry_info_search_auth_db_multi_read" function_type="db_multi_read">
		...
		<exec_function function_name="view_lms_enquiry_data_compose_response" function_type="compose_response">
			<response_info>
				<resp_obj obj_name="lms_enquiry_table_list" obj_type="object" data_source="lms_enquiry_table_list"></resp_obj>
			</response_info>
		</exec_function>
	</exec_group>
	</sem_lexical_parser>
