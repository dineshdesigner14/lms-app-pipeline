...
func GetViewLMSCourseProgressProdServiceXML() interface{} {
	lexicalParserStr := `
	<sem_lexical_parser microservice="view_lms_course">
	   <exec_group group_name="view_lms_course_data_pagination" group_condition="ReqBrokerReqObj.header_data.channel=='web_admin_portal' &amp;&amp; (ReqBrokerReqObj.request_data.page!=nil &amp;&amp; ReqBrokerReqObj.request_data.per_page!=nil)">
