...
func HandleOTPResend(reqBrokerDataMap map[string]interface{}) int {
	var respBuffer []byte
	...
	reqBuffer := reqbrokerutil.TranslateInternalMsg("ResendOTP", serviceutil.GetServiceName(), lmsapiengdef.LMSApiEngVersion, json.RawMessage(otpObjMapBuffer))
